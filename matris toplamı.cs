...
{
     class matristoplamiislem
{
    public static string matristoplamsonuc(string matris1Str,string matris2Str)
    {
        ...
        var toplam = MatrisToplami(matris1, matris2);
            
        return MatrisYazdir(toplam, matris1);
    ...
    static List<double> MatrisToplami(List<List<string>> matris1, List<List<string>> matris2)
    {
